package StdClasses; /******************************************************************************
 *  Compilation:  javac StdClasses.In.java
 *  Execution:    java StdClasses.In   (basic test --- see source for required files)
 *  Dependencies: none
 *
...
public final class In {
    ...
    public In(File file) {
        ...
        try {
            // for consistency with StdClasses.StdIn, wrap with BufferedInputStream instead of use
     ...
     * @deprecated Replaced by {@code new StdClasses.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new StdClasses.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new StdClasses.In(filename)}.{@link #readAllStrings()}.
     */
    @Deprecated
    ...
    /**
     * Unit tests the {@code StdClasses.In} data type.
     *
