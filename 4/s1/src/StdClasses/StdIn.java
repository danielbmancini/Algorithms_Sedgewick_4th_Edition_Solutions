package StdClasses; /******************************************************************************
 *  Compilation:  javac StdClasses.StdIn.java
 *  Execution:    java StdClasses.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 * <p><b>Overview.</b>
 * The {@code StdClasses.StdIn} class provides static methods for reading strings
 ...
 * p>
 * <b>Getting started.</b>
 * To use this class, you must have {@code StdClasses.StdIn.class} in your
 * Java classpath. If you used our autoinstaller, you should be all set.
 * Otherwise, either download
 * <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 * and add to your Java classpath or download
 * <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">StdClasses.StdIn.java</a>
 ...
 * <pre>
 * while (!StdClasses.StdIn.isEmpty()) {
 *     double value = StdClasses.StdIn.readDouble();
 *     StdClasses.StdOut.println(value);
 * }
 * </pre>
 * p>
 ...
 * <pre>
 * while (StdClasses.StdIn.hasNextChar()) {
 *     char c = StdClasses.StdIn.readChar();
 *     StdClasses.StdOut.print(c);
 * }
 * </pre>
 * p>
 ...
 * <pre>
 * while (StdClasses.StdIn.hasNextLine()) {
 *     String line = StdClasses.StdIn.readLine();
 *     StdClasses.StdOut.println(line);
 * }
 * </pre>
 * p>
 ...
 * <pre>
 * String[] words = StdClasses.StdIn.readAllStrings();
 * </pre>
 * p>
 * <b>Differences with Scanner.</b>
 * {@code StdClasses.StdIn} and {@link Scanner} are both designed to parse
 * tokens and convert them to primitive types and strings.
 * The main differences are summarized below:
 * <ul>
 * <li> {@code StdClasses.StdIn} is a set of static methods and reads
 ...
 *      and sockets.
 * <li> {@code StdClasses.StdIn} uses whitespace as the delimiter pattern
 *      that separates tokens.
 *      {@link Scanner} supports arbitrary delimiter patterns.
 * <li> {@code StdClasses.StdIn} coerces the character-set encoding to UTF-8,
 *      which is the most widely used character encoding for Unicode.
 * <li> {@code StdClasses.StdIn} coerces the locale to {@link Locale#US},
 *      for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *      and floating-point literals.
 * <li> {@code StdClasses.StdIn} has convenient methods for reading a single
 *      character; reading in sequences of integers, doubles, or strings;
 *      and reading in all of the remaining input.
 * </ul>
 * p>
 * Historical note: {@code StdClasses.StdIn} preceded {@code Scanner}; when
 ...
 * Windows, and Linux.
 * The methods in {@code StdClasses.StdIn} are <em>blocking</em>, which means that they
 ...
 * If the input begins with the optional byte-order mask, {@code StdClasses.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from StdClasses.In to StdClasses.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from StdClasses.In to StdClasses.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from StdClasses.In to StdClasses.StdIn,
    ...
    public static char readChar() {
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)StdClasses.In.readChar() error!"
    ...
    //// end: section (2 of 2) of code duplicated from StdClasses.In to StdClasses.StdIn

    // do this once when StdClasses.StdIn is initialized
    static {
        resync();
    }

    /**
     * If StdClasses.StdIn changes, use this to reinitialize the scanner.
     */
